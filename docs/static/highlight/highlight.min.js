...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `rust` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("rust",e)})();/*! `plaintext` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("bash",e)})();/*! `cpp` grammar compiled for Highlight.js 11.7.0 */
